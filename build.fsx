...
let project         = "FSharpSpreadsheetML"
let summary         = "FSharp wrapper for Open XML SDK, allowing Excel File reading and manipulation"
let solutionFile    = "FSharpSpreadsheetML.sln"
let configuration   = "Release"

let testProject = "tests/FSharpSpreadsheetML.Tests.NetCore/FSharpSpreadsheetML.Tests.NetCore.fsproj"
let testAssemblies = "tests/**/bin" </> configuration </> "**" </> "*Tests.exe"

let gitOwner = "CSBiology"
let gitHome = sprintf "%s/%s" "https://github.com" gitOwner
let gitName = "FSharpSpreadsheetML"

let website = "/FSharpSpreadsheetML"
let pkgDir = "temp"
let docLink = "https://CSBiology.github.io/FSharpSpreadsheetML/"
